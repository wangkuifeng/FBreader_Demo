...
public final class FBReader extends ZLAndroidActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		addMenuItem(menu, ActionCode.SHOW_NETWORK_LIBRARY, R.drawable.ic_menu_networklibrary);//在线书库
		addMenuItem(menu, ActionCode.SHOW_TOC, R.drawable.ic_menu_toc);//目录
		addMenuItem(menu, ActionCode.SHOW_BOOKMARKS, R.drawable.ic_menu_bookmarks);//书签
		addMenuItem(menu, ActionCode.SWITCH_TO_NIGHT_PROFILE, R.drawable.ic_menu_night);//黑底白字
		addMenuItem(menu, ActionCode.SWITCH_TO_DAY_PROFILE, R.drawable.ic_menu_day);//白底黑字
