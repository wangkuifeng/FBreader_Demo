...
public final class FBReaderApp extends ZLApplication {
	...
	public FBReaderApp(String arg) {
		...
		addAction(ActionCode.CLEAR_FIND_RESULTS, new ClearFindResultsAction(this));//清除查找结果
		...
		addAction(ActionCode.SWITCH_TO_DAY_PROFILE, new SwitchProfileAction(this, ColorProfile.DAY));//黑底白字
		addAction(ActionCode.SWITCH_TO_NIGHT_PROFILE, new SwitchProfileAction(this, ColorProfile.NIGHT));//白底黑字
